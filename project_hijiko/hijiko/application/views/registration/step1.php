...
<div ng-controller="registrationStep1Ctrl">
<div class="container">
	<div class="row">
...
<div class="container">
	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		<div id="step1box1" class="box myfreerate-box" style="">
		<form name="step1box1Form" novalidate>
					...
					<div class="col-lg-6 col-md-6 col-sm-6">
				            ...
				            <div class="">
							   ...
							   <div class="col-lg-12 col-md-12 col-sm-12">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
								   <input ng-model="vendorLocation" name="vendorLocation" type="text" class="form-control margin-bottom-20" placeholder="Seoul City Hall" googleplace required>
								   <!--
								   <input ng-model="vendorLocation" name="vendorLocation" type="text" class="form-control margin-bottom-20" placeholder="Seoul City Hall" required>-->
								<button class="btn btn-success" ng-click="goToStep1Box2()" ng-disabled="step1box1Form.$invalid">Continue</button>
								</div>
				 			  </div>
		...
		<div id="step1box2" class="box myfreerate-box" style="display: none;">
		<form name="step1box2Form" novalidate>
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="progressbar">
				            ...
				            <div class="">
							   ...
							   <div class="row">
								   <div class="Morelng">
										<div class="spr_selector">
											<label class="fa fa-sort-desc"></label>
											<select class="spr_select" ng-model="vendorPLang" required>
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
							   <div class="row">
								   <div class="Morelng">
										<div class="spr_selector">
											<label class="fa fa-sort-desc"></label>
											<select class="spr_select" ng-model="vendorSLang" ng-change="addSLang()">													
													<option ng-repeat="language in languages" value="{{language.langFName}}">{{language.langFName}}</option>
											</select>
										</div>
	     							</div>
	     							...
	     							<div class="list-lang">
	     								<ul>
	     									<li ng-repeat="vendorSLanguage in vendorSLanguages">{{vendorSLanguage.langFName}} <button class="box-btn" ng-click="removeSLang(vendorSLanguage)">Spanish</button></li>						
	     								</ul>
	     							</div>
	     							
	     							
	     							<button class="back" ng-click="goToStep1Box1()"><i class="fa fa-long-arrow-left icon-right"></i>Back</button>
	     							<button class="next" ng-click="goToStep1Box3()" ng-disabled="step1box2Form.$invalid">Next</button>
							</div>
								</div>
	...
	<div id="step1box3" class="box myfreerate-box" style="display: none;">
			<form name="step1box3Form" novalidate>
			<div class="col-lg-12 col-md-12 col-sm-12">
			<div class="progressbar">
						   ...
						   <div class="col-lg-12 col-md-12 col-sm-12">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
							   <div class="Morelng">
									<div class="spr_selector">
										<label class="fa fa-sort-desc"></label>
								<select class="spr_select" ng-model="vendorPCategory" ng-change="addPcat()">												
    							...
    							<p class="small">You may choose up to 5 categories.</p>
								   	<div class="box cat-list-box">
								   		<ul>
								   			<li ng-repeat="vendorPCategory in vendorPCategories"><img src="{{vendorPCategory.pcatImageLink}}" class="margin-right15" height="20" width="20"><span>{{vendorPCategory.pcatName}}</span>
								   			 <button class="box-btn" ng-click="removePcat(vendorPCategory)"></button></li>
								   		</ul>
								   	</div>					
								</div>
     							...
     							<button class="back" ng-click="goToStep1Box2()"><i class="fa fa-long-arrow-left icon-right"></i>Back</button>
     							<button class="next" ng-click="goToStep1Box4()">Next</button>
		...
		<div id="step1box4" class="box myfreerate-box" style="display: none;">
							...
							<div class="box signup-div">
							   ...
							   <div class="col-lg-12 col-md-12 col-sm-12">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
									   ...
									   <div class="Morelng">
											<div class="spr_selector">
												<label class="fa fa-sort-desc"></label>
													<select class="spr_select" ng-model="vendorCountry" required>													
				 			  ...
				 			  <div class="pickitem-frm-box">
								...
								<div class="col-lg-6 col-md-6 col-sm-12">
								  	 <p>State</p>
									  <div class="form-group">
									  <input type="text" class="form-control" ng-model="vendorState" name="vendorState" required>
			 			  		...
			 			  		<div class="col-lg-6 col-md-6 col-sm-12">
								  	 <p>city</p>
									  <div class="form-group">
									  <input type="text" class="form-control" ng-model="vendorCity" name="vendorCity" required>
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
								  	 <p>Street Address</p>
									   <div class="form-group">
										  <textarea class="form-control" rows="5" id="comment" ng-model="vendorStreetAddress" name="vendorStreetAddress" required></textarea>
				 			  ...
				 			  <div class="pickitem-frm-box">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
								  	 <p>Apt, Suite, Blog</p>
									  <div class="form-group">
									  <input type="text" class="form-control" ng-model="vendorWebsite" name="vendorWebsite" required>
				 			  ...
				 			  <div class="pickitem-frm-box">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
								  	 <p>ZIP Code</p>
									  <div class="form-group">
									  <input type="number" class="form-control" ng-model="vendorZipCode" name="vendorZipCode" required>
				 			   ...
				 			   <div class="pickitem-frm-box">
				 			  		<div class="col-lg-12 col-md-12 col-sm-12">
	     								<button class="back" ng-click="goToStep1Box3()"><i class="fa fa-long-arrow-left icon-right"></i>Back</button>
	     								<button class="next" ng-click="goToStep1Box5()" ng-disabled="step1box4Form.$invalid">Next</button>
									</div>
			 			  		</div>
		...
		<div id="step1box5" class="box myfreerate-box" style="display: none;">
							   ...
							   <div class="col-lg-12 col-md-12 col-sm-12">
						    	...
						    	<div class="col-lg-12 col-md-12 col-sm-12">
						    		<div class="signup-map">
						    			...
						    			<div id="myMap" style="height: 280px; width: 100%"></div>
						    			<!--
				 			   ...
				 			   <div class="pickitem-frm-box">
				 			  		<div class="col-lg-12 col-md-12 col-sm-12">
	     								...
	     								<button class="next" ng-click="goToStep1Finish()">Finish</button>
									</div>
			 			  		</div>
		...
		<div id="step1box6" class="box myfreerate-box" style="display: none;">
