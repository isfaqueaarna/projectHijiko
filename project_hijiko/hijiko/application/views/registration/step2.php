...
<div ng-controller="registrationStep2Ctrl">
<div class="container">
	<div class="row">
...
<div class="container">
	...
	<div class="col-lg-12 col-md-12 col-sm-12">
		...
		<div id="step2box1" class="box myfreerate-box" style="">
	...
	<div id="step2box2" class="box myfreerate-box" style="display: none;">
		<form name="step2box2Form" novalidate>
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
						<div class="box signup-div">
						   ...
						   <div class="col-lg-12 col-md-12 col-sm-12">
						   		...
						   		<h4><strong>Please upload your photo ID.</strong></h4>
                             ...
                             ngf-model-invalid="errorFile">
										<i class="fa fa-cloud-upload icon-right"></i>upload file
                             			...
                             			<i ng-show="step2box2Form.picPhotoId.$error.required">*required</i><br>
                      <i ng-show="step2box2Form.picPhotoId.$error.maxSize">File too large 
                          {{errorFile.size / 1000000|number:1}}MB: max 2M</i>
						   		...
						   		<div class="col-lg-5 col-md-5 col-sm-12">
									<div class="row">
										<div class="prv-img"><img ng-show="step2box2Form.picPhotoId.$valid" ngf-thumbnail="picPhotoId" height="180" width="180"></div>
									</div>
						   		</div>
						   		<!--
								...
								<div class="pickitem-frm-box">
			 			  		<div class="col-lg-12 col-md-12 col-sm-12">
     								...
     								<button class="next" ng-click="goToStep2Box3File(picPhotoId)" ng-disabled="step2box2Form.$invalid">Next</button>
								</div>
		 			  		</div>
							</div>
	...
	<div id="step2box3" class="box myfreerate-box" style="display: none;">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
						<div class="box signup-div">
						   ...
						   <div class="col-lg-12 col-md-12 col-sm-12">
					   		<div class="row">
						   		<h4><strong>Add your email address</strong></h4>
						   		...
						   		<div id="step2box3_1" class="col-lg-9 col-md-9 col-sm-12">
									<div class="row">
						   		...
						   		<div class="clearfix"></div>
										...
										<div class="box code-msg" id="step2box3_2" style="display: none;">
										<div class="col-lg-3 col-md-3 col-md-12">
											<div class="row">
						   		...
						   		<div class="col-lg-9 col-md-9 col-sm-12">
									...
									<!--code success box-->
										...
										<div class="box code-msg" id="step2box3_3" style="display: none;">
										<div class="col-lg-3 col-md-3 col-md-12">
											<div class="row">
												<img src="<?php echo base_url();?>assets/images/suc-mail-icon.png">
											</div>
						   		...
						   		<div class="col-lg-9 col-md-9 col-sm-12">
									<div class="row">
										<div class="input-group inp-box">
										  <input type="text" class="form-control suc-mail" placeholder="{{vdEmail}}">
								...
								<div class="pickitem-frm-box" id="step2box3_4" style="display: none;">
			 			  		<div class="col-lg-12 col-md-12 col-sm-12">
	...
	<div id="step2box4" class="box myfreerate-box" style="display: none;">
			...
			<div class="col-lg-12 col-md-12 col-sm-12">
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
						<div class="box signup-div">
						   ...
						   <div class="col-lg-12 col-md-12 col-sm-12">
					   		<div class="row">
						   		<h4><strong>Add your mobile number</strong></h4>
						   		...
						   		<div id="step2box4_1" class="col-lg-9 col-md-9 col-sm-12" style="">
									<div class="row">
						   		...
						   		<div class="clearfix"></div>
										...
										<div id="step2box4_2" class="box code-msg" style="display: none;">
										<div class="col-lg-3 col-md-3 col-md-12">
											<div class="row">
						   		...
						   		<div class="col-lg-9 col-md-9 col-sm-12">
									<div class="row">
									<div class="code-gnrt-box">
										Ok, check your phone(+91 {{vdMobile}})
for a text from us. Enter the 4-digit code.
									<div class="clearfix"></div>
										...
										<p class="small"><a href="#" class="small">Try again</a> . <a href="" ng-click="callmeInstead()" class="small">Call me instead</a></p>
											...
											<div id="step2box4_3" class="box code-msg" style="display: none;">
										<div class="col-lg-3 col-md-3 col-md-12">
											<div class="row">
						   		...
						   		<div class="col-lg-9 col-md-9 col-sm-12">
									<div class="row">
									<div class="code-gnrt-box">
										Ok, we’ll call +91 {{vdMobile}} with a code.
Enter the 4-digit code.
									...
									<!--code success box-->
										...
										<div id="step2box4_4" class="box code-msg" style="display: none;">
										<div class="col-lg-3 col-md-3 col-md-12">
											<div class="row">
												<img src="<?php echo base_url();?>assets/images/phone-icon.png">
											</div>
						   		...
						   		<div class="col-lg-9 col-md-9 col-sm-12">
									<div class="row">
									  ...
									  <span class="input-group-addon">+91</span>
										  <input type="text" class="form-control suc-mail" placeholder="{{vdMobile}}">
										  <span class="input-group-addon check-icon"><i class="fa fa-check-circle"></i></span>
										</div>
									</div>
						   		</div>
								...
								<div id="step2box4_5" class="pickitem-frm-box" style="display: none;">
			 			  		<div class="col-lg-12 col-md-12 col-sm-12">
