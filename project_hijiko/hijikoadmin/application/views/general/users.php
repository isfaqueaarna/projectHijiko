<div class="wrapper" ng-controller="usersCtrl">
    ...
    <section class="sidebar">
      ...
      <li class="treeview active" class="contentsmenu">
        ...
        <ul class="treeview-menu">
          <li class="active"><a href="users"><i class="glyphicon glyphicon-triangle-right"></i> <span>User</span></a></li>
            ...
            <table class="table table-hover">
              <thead>
                <tr>
                  ...
                  <th ng-click="sort('userFirstName')">First Name
                    <span class="glyphicon sort-icon" ng-show="sortKey=='userFirstName'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                  </th>
                  <th ng-click="sort('userLastName')">Last Name
                    <span class="glyphicon sort-icon" ng-show="sortKey=='userLastName'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                  </th>
                  <th ng-click="sort('userEmail')">Email
                    <span class="glyphicon sort-icon" ng-show="sortKey=='userEmail'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                  </th>
                  <th ng-click="sort('userStatus')">Status
                    <span class="glyphicon sort-icon" ng-show="sortKey=='userStatus'" ng-class="{'glyphicon-chevron-up':reverse,'glyphicon-chevron-down':!reverse}"></span>
                  </th>
                  <th>Action</th>
                </tr>
              </thead>
              <tbody>
                <tr dir-paginate="user in users|orderBy:sortKey:reverse|filter:search|itemsPerPage:5">
                  ...
                  <td><span ng-class='whatClassIsIt(user.userStatus)'>{{user.userStatus}}</span></td>
                  <td>
                    <a class="btn btn-social-icon btn-danger" ng-click="changeStatus(user)" title="Change Status"><i class="fa fa-check-circle"></i></a>
                  </td>
                </tr>
              </tbody>
              </table>
