<div ng-controller="signupCtrl" class="register-box">
  <div class="register-logo" style="text-shadow: 0px 2px 5px rgba(0,0,0,0.3);">
    <a href="../../index2.html"><b>HiJiko</b>Admin</a>
  </div>
  ...
  <div class="register-box-body" style="box-shadow: 0 6px 6px -1px rgba(0,0,0,0.5);">
    ...
    <form name="signupForm" novalidate>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" ng-model="userFullName" name="userFullName" placeholder="Full name" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
        <span style="color:red;" ng-show="signupForm.userFullName.$dirty && signupForm.userFullName.$invalid">
          <span ng-show="signupForm.userFullName.$error.required">Full Name is required</span>
        </span>
      </div>
      <div class="form-group has-feedback">
